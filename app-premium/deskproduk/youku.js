document.addEventListener('DOMContentLoaded', () => {
    ...
    // ⚠️ Data spesifik untuk produk Youku
    const productData = {
        id: 'youku',
        name: 'Youku',
        ...
        features: [
            "Akses VIP ke drama dan film China terbaru",
            "Tonton konten eksklusif Youku Original",
            "Streaming bebas iklan",
            "Kualitas video Full HD",
            "Download untuk ditonton secara offline"
        ],
        compatibility: [ "Android", "iOS", "Website", "Smart TV" ],
        terms: "Akun bersifat sharing atau private sesuai varian. Dilarang mengubah detail akun yang diberikan.",
        variants: [
            { name: 'Sharing - 1 Bulan', price: 13000, oldPrice: 30000, discount: 57 },
            { name: 'Sharing - 3 Bulan', price: 24000, oldPrice: 90000, discount: 73 },
            { name: 'Private - 1 Bulan', price: 38000, oldPrice: 70000, discount: 46 },
        ]
    };
