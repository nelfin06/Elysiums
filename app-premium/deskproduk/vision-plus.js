document.addEventListener('DOMContentLoaded', () => {
    ...
    // ⚠️ Data spesifik untuk produk Vision+
    const productData = {
        id: 'vision-plus',
        name: 'Vision+',
        ...
        features: [
            "Akses ke channel TV Nasional & Internasional",
            "Tonton Vision+ Originals",
            "Ribuan jam film dan serial VOD",
            "Siaran ulang acara TV hingga 7 hari ke belakang",
            "Fitur Nonton Bareng"
        ],
        compatibility: [ "Android", "iOS", "Website" ],
        terms: "Aktivasi menggunakan nomor HP. Pastikan nomor belum pernah terdaftar di Vision+.",
        variants: [
            { name: 'Sharing - 1 Bulan', price: 23000, oldPrice: 35000, discount: 34 },
            { name: 'Private - 1 Bulan', price: 30000, oldPrice: 45000, discount: 33 },
        ]
    };
    ...
    // (Sama persis dengan template Anda)
