document.addEventListener('DOMContentLoaded', () => {
    ...
    // ⚠️ Data spesifik untuk produk AI Perplexity
    const productData = {
        id: 'perplexity',
        name: 'AI Perplexity',
    ...
    // ... (sisa kode JavaScript sama persis dengan file sebelumnya) ...
    ...
    productData.variants.forEach((variant, index) => {
        ...
        item.innerHTML = `<div class="variant-top"><span class="variant-name">${variant.name}</span><div class="selector"></div></div><hr class="variant-divider"><div class="variant-bottom"><div class="variant-stock"><i class="fa-solid fa-wand-sparkles"></i> HABIS</div><div class="variant-pricing"><span class="current-price">Rp. ${variant.price.toLocaleString('id-ID')}</span><div class="old-price-container"><span class="old-price">Rp. ${variant.oldPrice.toLocaleString('id-ID')}</span><span class="discount">${variant.discount}%</span></div></div></div>`;
